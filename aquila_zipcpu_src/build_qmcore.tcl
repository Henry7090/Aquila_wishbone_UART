...
set common_files [list \
  ...
  [file normalize "$origin_dir/src/soc_rtl/core2wishbonespi_if.v" ]\
  [file normalize "$origin_dir/src/soc_rtl/core2wishboneuart_if.v" ]\
  [file normalize "$origin_dir/src/soc_rtl/cdc_sync.v" ]\
  [file normalize "$origin_dir/src/soc_rtl/mem_arbiter.v" ]\
  [file normalize "$origin_dir/src/soc_rtl/spi/llsdspi.v" ]\
  [file normalize "$origin_dir/src/soc_rtl/spi/sdspi.v" ]\
  [file normalize "$origin_dir/src/soc_rtl/spi/spicmd.v" ]\
  [file normalize "$origin_dir/src/soc_rtl/spi/spirxdata.v" ]\
  [file normalize "$origin_dir/src/soc_rtl/spi/spitxdata.v" ]\
  [file normalize "$origin_dir/src/soc_rtl/uart/axiluart.v"] \
  [file normalize "$origin_dir/src/soc_rtl/uart/rxuart.v"] \
  [file normalize "$origin_dir/src/soc_rtl/uart/rxuartlite.v"] \
  [file normalize "$origin_dir/src/soc_rtl/uart/skidbuffer.v"] \
  [file normalize "$origin_dir/src/soc_rtl/uart/txuart.v"] \
  [file normalize "$origin_dir/src/soc_rtl/uart/txuartlite.v"] \
  [file normalize "$origin_dir/src/soc_rtl/uart/ufifo.v"] \
  [file normalize "$origin_dir/src/soc_rtl/uart/wbuart.v"] \
  [file normalize "$origin_dir/src/soc_rtl/uart/wbuart-insert.v"]\
...
# Define the target board to "QMTech Core Board" for synthesis
set_property verilog_define [list QMCore] [get_filesets sources_1]
...
set files [list \
  [file normalize "$origin_dir/src/xdc/qmcore.xdc"]\
]
...
# Define the target board to "QMTech Core Board" for simulation
set_property verilog_define [list QMCore] [get_filesets sim_1]
...
file copy $origin_dir/src/mig/mig-qmcore.prj ${proj_name}/${proj_name}.srcs/sources_1/ip/mig_7series_0/mig.prj
